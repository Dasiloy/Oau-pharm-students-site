...
<div className='lg:flex hi flex-col lg:flex-row w-[70%] p-[1.5rem] lg:p-[4rem] gap-8 items-center justify-center bg-[url("/assests/rectangle9.png")] '>
...
<div className='flex flex-col lg:items-center lg:justify-center gap-4'>
  <input placeholder='Enter Your Full Name' type='text' className='border-[1px] rounded-lg text-dark-dark-75 w-fit lg:w-[515px] lg:h-[65px] h-[40px] outline-none pl-2 lg:pl-4' />
  <input placeholder='Enter Your Mail' type='email'className='border-[1px] rounded-lg text-dark-dark-75 w-fit lg:w-[515px] lg:h-[65px] h-[40px] outline-none pl-4 pl-2 lg:pl-4 ' />
  <input placeholder='Enter Your Phone number' type='number'className='border-[1px] rounded-lg text-dark-dark-75 w-fit lg:w-[515px] lg:h-[65px] h-[40px] outline-none pl-4 pl-2 lg:pl-4 ' />
  <textarea placeholder='Message '  className='border-[1px] rounded-lg text-dark-dark-75 w-max lg:w-[515px] lg:h-[65px] h-[90px] outline-none   pl-2 lg:pl-4'></textarea>
</div>
</div>
